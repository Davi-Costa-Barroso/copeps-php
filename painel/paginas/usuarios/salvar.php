...
$query = $pdo->prepare("UPDATE $tabela SET nome = :nome, email = :email, nivel = '$nivel', telefone = :telefone, endereco = :endereco, matricula = :matricula, comissao = :comissao where id = '$id'");
}
