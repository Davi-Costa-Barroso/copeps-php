...
?> 
	...
	<!-- Botão Inserir novo usuario com a função "inserir()" via "ajax.js" -->
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">							
								...
								<input type="text" class="form-control" id="matricula" name="matricula" placeholder="Sua Matricula" >							
						</div>
					...
					<div class="row">
						...
						<div class="col-md-5"> 							
								...
								<?php } }else{ ?>
									<option value="">Cadastre um Membro / Nivel</option>
								<?php } ?>
								</select>							
						</div>
